...
class TestUpdateDns(unittest.TestCase):
    ...
    def test_successful_update(
        ...
        result = godaddy_ddns.update_dns("home.example.com", "key", "secret", 3600)
    ...
    def test_invalid_hostname_single_label(self) -> None:
        result = godaddy_ddns.update_dns("localhost", "key", "secret", 3600)
    ...
    def test_domain_only_inserts_at_record(
        ...
        result = godaddy_ddns.update_dns("example.com", "key", "secret", 3600)
        self.assertTrue(result)
...
class TestMain(unittest.TestCase):
    ...
    @patch("godaddy_ddns.read_k8s_secret")
    @patch("godaddy_ddns.update_dns", return_value=True)
